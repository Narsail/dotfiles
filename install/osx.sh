...
defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "$compname"
...
echo "Disabling showing icons for hard drives and removable media on the desktop"
...
apps_to_start_at_login=("/Applications/Flux.app", "/Applications/Dropbox.app", "/Applications/Google Drive.app", "/Applications/Bartender.app", "/Applications/Hazel.app")
